...
[**getReleaseCoverArt**](MusicBrainzAPI.md#getreleasecoverart) | **GET** /musicbrainz/release/{mbid}/cover-art | 
[**getReleaseCoverArtInfo**](MusicBrainzAPI.md#getreleasecoverartinfo) | **GET** /musicbrainz/release/{mbid}/cover-art-info | 
[**getReleaseGroupCoverArt**](MusicBrainzAPI.md#getreleasegroupcoverart) | **GET** /musicbrainz/release-group/{mbid}/cover-art | 
...
# **getReleaseCoverArt**
```swift
    open class func getReleaseCoverArt(mbid: String, completion: @escaping (_ data: CoverArtArchive?, _ error: Error?) -> Void)
```
...
MusicBrainzAPI.getReleaseCoverArt(mbid: mbid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
[**CoverArtArchive**](CoverArtArchive.md)
...
# **getReleaseCoverArtInfo**
```swift
    open class func getReleaseCoverArtInfo(mbid: String, completion: @escaping (_ data: CoverArtInfo?, _ error: Error?) -> Void)
```
...
MusicBrainzAPI.getReleaseCoverArtInfo(mbid: mbid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getReleaseGroupCoverArt(mbid: String, completion: @escaping (_ data: CoverArtArchive?, _ error: Error?) -> Void)
```
...
MusicBrainzAPI.getReleaseGroupCoverArt(mbid: mbid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
